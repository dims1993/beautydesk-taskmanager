...
export default function Landing() {
  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen text-[#5d5045] font-sans antialiased selection:bg-[#f5ebe0]">
      ...
      {/* Hero: móvil = copy → móviles (imágenes enteras) → CTA; md+ = copy+CTA | showcase */}
      <header className="max-w-7xl mx-auto pt-24 md:pt-28 md:mt-8 px-0 md:px-16 pb-20 md:pb-32">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-20">
          <div className="order-1 md:order-none flex-1 w-full space-y-6 md:space-y-10 px-8 md:px-0 text-left relative z-30">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl sm:text-5xl md:text-[6.5rem] lg:text-[7.5rem] font-serif leading-[1.05] md:leading-[0.88] tracking-tighter text-[#5d5045]">
                Eleva el <br className="hidden md:block" />
                flujo diario <br />
                <span className="italic opacity-80 underline decoration-[#eaddcf]/70 decoration-1 underline-offset-[12px] md:underline-offset-[14px]">
                  de tu salón.
                </span>
              </h2>
            </div>
            ...
            <div className="hidden md:flex flex-col sm:flex-row items-center justify-start gap-6 pt-6">
              <Link
                to="/contacto"
          ...
          <div
            className="order-2 md:order-last relative w-full md:w-[50%] min-h-[320px] sm:min-h-[380px] md:min-h-[700px] md:h-[700px] flex items-center justify-center p-2 sm:p-4 md:p-0             overflow-visible"
          >
            <div className="absolute w-[100%] sm:w-[120%] h-[90%] max-md:max-h-[480px] bg-[#f5ebe0] rounded-full blur-[100px] md:blur-[140px] opacity-40 md:translate-y-0 pointer-events-none" />

            <div className="absolute left-[0%] sm:left-[5%] md:left-[-10%] top-[18%] md:top-[25%] w-[128px] sm:w-[150px] md:w-[220px] aspect-[9/18.5] bg-white rounded-[2rem] shadow-[0_15px_40px_-10px_rgba(93,80,69,0.15)] border border-[#eaddcf]/50 z-10 scale-90 sm:scale-95 md:scale-100 opacity-90 md:opacity-100 rotate-[-5deg] md:rotate-[-8deg] overflow-hidden p-1.5 hover:rotate-0 transition-transform duration-500">
              <img
                src="/hero.png"
                alt="Gestión de Clientes en BeautyTask"
                className="w-full h-full object-contain md:object-cover rounded-[1.8rem] bg-white"
                onError={(e) =>
                  (e.target.src =
            ...
            <div className="relative w-[200px] sm:w-[220px] md:w-[280px] aspect-[9/19.5] bg-[#1a1a1a] rounded-[2.8rem] p-1.5 shadow-[0_40px_110px_-25px_rgba(93,80,69,0.35)] border-[4px] border-[#332d29] z-20 hover:scale-105 hover:border-[#4a3f36] transition-all duration-700 ease-out group">
              ...
              <div className="w-full h-full bg-white rounded-[2.4rem] overflow-hidden relative flex flex-col p-0.5">
                <div className="flex-1 min-h-0 rounded-[2.2rem] overflow-hidden bg-gray-50 border border-[#eaddcf]/20 shadow-inner group-hover:rotate-1 transition-transform duration-1000 flex items-start justify-center">
                  <img
                    src="/hero2.png"
                ...
                <div className="absolute inset-x-2 bottom-2 h-1/2 bg-gradient-to-t from-white via-white/50 to-transparent rounded-b-[2rem] pointer-events-none" />
                <div className="absolute bottom-4 left-4 right-4 z-10 space-y-1 md:bottom-6 md:left-6 md:right-6">
                  <div className="w-10 h-1 bg-[#5d5045]/40 rounded-full" />
                  <p className="text-base sm:text-lg md:text-xl font-serif text-[#5d5045] leading-tight">
                    Control Total.
                  </p>
                </div>
              </div>
            ...
            <div className="absolute right-[0%] sm:right-[5%] md:right-[-8%] bottom-[15%] md:bottom-[20%] w-[128px] sm:w-[150px] md:w-[220px] aspect-[9/18.5] bg-white rounded-[2rem] shadow-[0_15px_40px_-10px_rgba(93,80,69,0.15)] border border-[#eaddcf]/50 z-10 scale-90 sm:scale-95 md:scale-100 opacity-90 md:opacity-100 rotate-[5deg] md:rotate-[8deg] overflow-hidden p-1.5 hover:rotate-0 transition-transform duration-500">
              <img
                src="/hero3.jpeg"
          ...
          <div className="order-3 md:hidden w-full px-8">
            <Link
              to="/contacto"
              className="flex w-full items-center justify-center gap-3 bg-[#5d5045] text-[#f5ebe0] px-12 py-6 rounded-full text-[11px] font-black uppercase tracking-[0.2em] hover:bg-[#4a3f36] transition shadow-2xl shadow-[#5d5045]/20 active:scale-95"
            >
              Contactar ahora
              <ChevronRight className="w-4 h-4" />
            </Link>
          ...
          {features.map((feature, index) => {
            ...
            if (feature.type === "image") {
              ...
              return (
                <div
                  key={index}
                  className={`relative overflow-hidden rounded-[2.5rem] border border-[#eaddcf] shadow-sm hover:shadow-2xl hover:shadow-[#5d5045]/10 transition-all duration-500 group min-h-[200px] md:min-h-0 ${feature.size}`}
                >
                  <img
                    src={feature.image}
                    alt={feature.alt}
                    className="w-full h-full min-h-[200px] object-contain md:object-cover bg-[#f0ebe4] transition-transform duration-700 md:group-hover:scale-110"
                  />
